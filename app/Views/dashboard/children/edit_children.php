...
?>
<form class="mt-5" action="<?= base_url('children/update') .'/' .$id ; ?>" method="POST">
    <?= csrf_field(); ?>
    ...
    <div class="form-group" data-aos="fade-right" data-aos-duration="500" data-aos-delay="500">
        ...
        <input type="text" name="children_name"
            ...
            placeholder="Input Children Name" id="children-name"
            value="<?= (old('children_name')) ? old('children_name') : $current_children['children_name']; ?>" />
    ...
    <div class="form-group" data-aos="fade-right" data-aos-duration="500" data-aos-delay="700">
        ...
        <input type="text" class="form-control <?= ($validation->hasError('code')) ? 'is-invalid':''; ?>"
            placeholder="Input Children Code" name="code" id="children-code"
            value="<?= (old('code')) ? old('code') : $current_children['code']; ?>" />
        <div class="invalid-feedback ">
